...
export interface AgentConfig {
  ...
  /**
   * MASAR: cultural perspective dimension — independent of the archetype persona.
   * The country/background this classmate speaks from, used to vary examples and
   * framings without stereotyping.
   */
  culturalPersona?: string;
...
export interface AgentTemplate {
  ...
  role: string;
  persona: string;
  /** MASAR: cultural perspective (country) — see AgentConfig.culturalPersona. */
  culturalPersona?: string;
  avatar: string;
  color: string;
